    ...
    return rx.dialog.root(
        ...
        rx.dialog.content(
            ...
            rx.flex(
                ...
                rx.input(placeholder="Username", on_blur=State.set_username),
                rx.text(
                    "Name",
                    as_="div",
                    size="2",
                ...
                rx.input(placeholder="Illness", on_blur=State.set_illness),
                rx.text(
                    "Language",
                    as_="div",
                    size="2",
                ...
                rx.input(placeholder="Language", on_blur=State.set_language),
                direction="column",
                spacing="3",
            ),
            rx.flex(
...
@template(route="/lahacks2024", title="Main")
